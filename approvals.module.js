...
<main class="main" id="main">
  ...
  <div class="page-content" id="pageContent">
    ...
    <!-- APROVAÇÕES — approvals.module.js -->
    <div class="page" id="page-approvals"><div id="approvals-module-container"></div></div>
    ...
    <!-- FORNECEDORES — suppliers.module.js -->
    <div class="page" id="page-suppliers"><div id="suppliers-module-container"></div></div>

    <!-- ANALYTICS — analytics.module.js -->
    <div class="page" id="page-analytics"><div id="analytics-module-container"></div></div>
...
// ================================================================
// razzo-data.js v2 -- Base REAL da Razzo (10_03.xlsx)
// Periodo: Abr/2023 a Mar/2026 | 45.182 registros
// 1740 fornecedores unicos | 17.921 pedidos unicos
// Importados: 50 fornecedores | 80 pedidos | 15 requisicoes
// ================================================================

(function injectRazzoData() {
  var razzoForns = [
    ...
    {id:'F320',sigla:'4S',razaoSocial:'4DS SOLUCOES',nomeFantasia:'4DS SOLUCOES',cnpj:'',ie:'',email:'carla.sinhori@4ds.com.br; luis.arao@4ds.com.br',emailNF:'carla.sinhori@4ds.com.br; luis.arao@4ds.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_320',portalSenha:'',portalAtivo:false,datasulCode:'320',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30676',sigla:'KS',razaoSocial:'KALUNGA SA',nomeFantasia:'KALUNGA SA',cnpj:'',ie:'',email:'thaistelevendas@kalunga.com.br',emailNF:'thaistelevendas@kalunga.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:8.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30676',portalSenha:'',portalAtivo:false,datasulCode:'30676',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F29953',sigla:'SM',razaoSocial:'SUPLLIES MAN',nomeFantasia:'SUPLLIES MAN',cnpj:'',ie:'',email:'supllies@supllies.com.br',emailNF:'supllies@supllies.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:7.5,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_29953',portalSenha:'',portalAtivo:false,datasulCode:'29953',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F747',sigla:'A',razaoSocial:'AUSTINACESS',nomeFantasia:'AUSTINACESS',cnpj:'',ie:'',email:'tiago.tavares@austincomercio.com.br',emailNF:'tiago.tavares@austincomercio.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:9.0,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_747',portalSenha:'',portalAtivo:false,datasulCode:'747',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30702',sigla:'MG',razaoSocial:'M.A.F. GARCI',nomeFantasia:'M.A.F. GARCI',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:6.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30702',portalSenha:'',portalAtivo:false,datasulCode:'30702',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F1144',sigla:'B',razaoSocial:'BRASILCENTE',nomeFantasia:'BRASILCENTE',cnpj:'',ie:'',email:'sac@brasilcentertruck.com.br',emailNF:'sac@brasilcentertruck.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_1144',portalSenha:'',portalAtivo:false,datasulCode:'1144',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F4374',sigla:'M',razaoSocial:'MODALMARCAS',nomeFantasia:'MODALMARCAS',cnpj:'',ie:'',email:'modal@modalmarcas.com.br',emailNF:'modal@modalmarcas.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_4374',portalSenha:'',portalAtivo:false,datasulCode:'4374',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3101',sigla:'G',razaoSocial:'GVSLOGR',nomeFantasia:'GVSLOGR',cnpj:'',ie:'',email:'atendimento@gvslog.com.br',emailNF:'atendimento@gvslog.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:9.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3101',portalSenha:'',portalAtivo:false,datasulCode:'3101',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F1271',sigla:'C',razaoSocial:'CACIQUE',nomeFantasia:'CACIQUE',cnpj:'',ie:'',email:'financeiro@molassupercacique.com.br; oss@molassupe',emailNF:'financeiro@molassupercacique.com.br; oss@molassupe',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:8.3,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_1271',portalSenha:'',portalAtivo:false,datasulCode:'1271',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2364',sigla:'D',razaoSocial:'DELL1',nomeFantasia:'DELL1',cnpj:'',ie:'',email:'tassiane.costa@dell.com',emailNF:'tassiane.costa@dell.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:7.6,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2364',portalSenha:'',portalAtivo:false,datasulCode:'2364',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F4444',sigla:'M',razaoSocial:'MWITACOGRAF',nomeFantasia:'MWITACOGRAF',cnpj:'',ie:'',email:'vdi@tacografos.com.br',emailNF:'vdi@tacografos.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:9.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_4444',portalSenha:'',portalAtivo:false,datasulCode:'4444',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F1437',sigla:'C',razaoSocial:'CASANANCY',nomeFantasia:'CASANANCY',cnpj:'',ie:'',email:'vendas@casanancy.com.br',emailNF:'vendas@casanancy.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.5,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_1437',portalSenha:'',portalAtivo:false,datasulCode:'1437',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2262',sigla:'C',razaoSocial:'CRISTALDISEL',nomeFantasia:'CRISTALDISEL',cnpj:'',ie:'',email:'laercio.cristaldiesel@gmail.com; cristaldiesel@uol',emailNF:'laercio.cristaldiesel@gmail.com; cristaldiesel@uol',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2262',portalSenha:'',portalAtivo:false,datasulCode:'2262',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F1408',sigla:'C',razaoSocial:'CARTREG',nomeFantasia:'CARTREG',cnpj:'',ie:'',email:'contato@cartoriodalapa.com.br',emailNF:'contato@cartoriodalapa.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:8.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_1408',portalSenha:'',portalAtivo:false,datasulCode:'1408',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30292',sigla:'BM',razaoSocial:'BIANCOS MANU',nomeFantasia:'BIANCOS MANU',cnpj:'',ie:'',email:'rafaela@biancosmanutencao.com.br; david@biancosman',emailNF:'rafaela@biancosmanutencao.com.br; david@biancosman',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:7.5,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30292',portalSenha:'',portalAtivo:false,datasulCode:'30292',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F5852',sigla:'S',razaoSocial:'SABESP',nomeFantasia:'SABESP',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:9.0,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_5852',portalSenha:'',portalAtivo:false,datasulCode:'5852',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F796',sigla:'B',razaoSocial:'BALJUNDIAI',nomeFantasia:'BALJUNDIAI',cnpj:'',ie:'',email:'faturamento@bjjundiai.com.br',emailNF:'faturamento@bjjundiai.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:6.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_796',portalSenha:'',portalAtivo:false,datasulCode:'796',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F794',sigla:'B',razaoSocial:'BALANCASJUN',nomeFantasia:'BALANCASJUN',cnpj:'',ie:'',email:'faturamento@bjjundiai.com.br',emailNF:'faturamento@bjjundiai.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_794',portalSenha:'',portalAtivo:false,datasulCode:'794',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F6637',sigla:'T',razaoSocial:'TOTVS',nomeFantasia:'TOTVS',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_6637',portalSenha:'',portalAtivo:false,datasulCode:'6637',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2429',sigla:'D',razaoSocial:'DIGICROM',nomeFantasia:'DIGICROM',cnpj:'',ie:'',email:'engenharia@digimed.ind.br',emailNF:'engenharia@digimed.ind.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:9.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2429',portalSenha:'',portalAtivo:false,datasulCode:'2429',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3211',sigla:'I',razaoSocial:'IDEALMAKUSI',nomeFantasia:'IDEALMAKUSI',cnpj:'',ie:'',email:'comprasidealmak98@hotmail.com',emailNF:'comprasidealmak98@hotmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:8.3,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3211',portalSenha:'',portalAtivo:false,datasulCode:'3211',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3847',sigla:'M',razaoSocial:'MARCAL&AZE',nomeFantasia:'MARCAL&AZE',cnpj:'',ie:'',email:'btscampinas@hotmail.com',emailNF:'btscampinas@hotmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:7.6,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3847',portalSenha:'',portalAtivo:false,datasulCode:'3847',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F1304',sigla:'C',razaoSocial:'CAMPSELOS1',nomeFantasia:'CAMPSELOS1',cnpj:'',ie:'',email:'vendas@campselos.com.br; eduardo.rigoleto@campselo',emailNF:'vendas@campselos.com.br; eduardo.rigoleto@campselo',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:9.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_1304',portalSenha:'',portalAtivo:false,datasulCode:'1304',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F29997',sigla:'GB',razaoSocial:'GLOBAL BELT',nomeFantasia:'GLOBAL BELT',cnpj:'',ie:'',email:'vendas1@globalcorreias.com.br;comercial@globalcorr',emailNF:'vendas1@globalcorreias.com.br;comercial@globalcorr',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.5,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_29997',portalSenha:'',portalAtivo:false,datasulCode:'29997',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F735',sigla:'A',razaoSocial:'ATIBRASIL',nomeFantasia:'ATIBRASIL',cnpj:'',ie:'',email:'ronaldo.sp@atibrasil.com.br;renata.sp@atibrasil.co',emailNF:'ronaldo.sp@atibrasil.com.br;renata.sp@atibrasil.co',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_735',portalSenha:'',portalAtivo:false,datasulCode:'735',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30565',sigla:'GL',razaoSocial:'GI LOSCHIAVO',nomeFantasia:'GI LOSCHIAVO',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:8.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30565',portalSenha:'',portalAtivo:false,datasulCode:'30565',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3820',sigla:'M',razaoSocial:'MAKSIWA',nomeFantasia:'MAKSIWA',cnpj:'',ie:'',email:'lauanda.pires@maksiwa.com.br; nivaldo@maksiwa.com.',emailNF:'lauanda.pires@maksiwa.com.br; nivaldo@maksiwa.com.',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:7.5,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3820',portalSenha:'',portalAtivo:false,datasulCode:'3820',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3209',sigla:'I',razaoSocial:'ICONIC',nomeFantasia:'ICONIC',cnpj:'',ie:'',email:'lubrificantes@ipiranga.ipiranga; Larissa.santos.ex',emailNF:'lubrificantes@ipiranga.ipiranga; Larissa.santos.ex',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:9.0,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3209',portalSenha:'',portalAtivo:false,datasulCode:'3209',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F5256',sigla:'R',razaoSocial:'R.O.L.',nomeFantasia:'R.O.L.',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:6.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_5256',portalSenha:'',portalAtivo:false,datasulCode:'5256',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2238',sigla:'C',razaoSocial:'CORREIO',nomeFantasia:'CORREIO',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2238',portalSenha:'',portalAtivo:false,datasulCode:'2238',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F880',sigla:'B',razaoSocial:'BIADOLA',nomeFantasia:'BIADOLA',cnpj:'',ie:'',email:'olivia.biadolatintas@hotmail.com',emailNF:'olivia.biadolatintas@hotmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_880',portalSenha:'',portalAtivo:false,datasulCode:'880',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2716',sigla:'F',razaoSocial:'F.M.G.CORRE',nomeFantasia:'F.M.G.CORRE',cnpj:'',ie:'',email:'vendasfmg02@gmail.com',emailNF:'vendasfmg02@gmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:9.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2716',portalSenha:'',portalAtivo:false,datasulCode:'2716',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F4536',sigla:'N',razaoSocial:'NNREDUTORES',nomeFantasia:'NNREDUTORES',cnpj:'',ie:'',email:'',emailNF:'',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:8.3,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_4536',portalSenha:'',portalAtivo:false,datasulCode:'4536',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30720',sigla:'LO',razaoSocial:'LUMAR ON LIN',nomeFantasia:'LUMAR ON LIN',cnpj:'',ie:'',email:'comercial2@automacao10.com.br',emailNF:'comercial2@automacao10.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:7.6,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30720',portalSenha:'',portalAtivo:false,datasulCode:'30720',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F4421',sigla:'M',razaoSocial:'MULTACOS',nomeFantasia:'MULTACOS',cnpj:'',ie:'',email:'mult-acos@uol.com.br',emailNF:'mult-acos@uol.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:9.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_4421',portalSenha:'',portalAtivo:false,datasulCode:'4421',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2977',sigla:'G',razaoSocial:'GENERALY',nomeFantasia:'GENERALY',cnpj:'',ie:'',email:'soraiageneraly@hotmail.com;genivalgeneraly@hotmail',emailNF:'soraiageneraly@hotmail.com;genivalgeneraly@hotmail',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.5,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2977',portalSenha:'',portalAtivo:false,datasulCode:'2977',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F6596',sigla:'T',razaoSocial:'THMAX',nomeFantasia:'THMAX',cnpj:'',ie:'',email:'augusto@thmax.com.br',emailNF:'augusto@thmax.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_6596',portalSenha:'',portalAtivo:false,datasulCode:'6596',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F3376',sigla:'J',razaoSocial:'J.NASCIMENT',nomeFantasia:'J.NASCIMENT',cnpj:'',ie:'',email:'j.nascimentoab11@hotmail.com',emailNF:'j.nascimentoab11@hotmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:8.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_3376',portalSenha:'',portalAtivo:false,datasulCode:'3376',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F757',sigla:'A',razaoSocial:'AUTOSSDUMO',nomeFantasia:'AUTOSSDUMO',cnpj:'',ie:'',email:'autopostosantosdumont@gmail.com',emailNF:'autopostosantosdumont@gmail.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:7.5,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_757',portalSenha:'',portalAtivo:false,datasulCode:'757',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2456',sigla:'D',razaoSocial:'DIVENA',nomeFantasia:'DIVENA',cnpj:'',ie:'',email:'janderson@divena.com.br; flavio.silva@divena.com.b',emailNF:'janderson@divena.com.br; flavio.silva@divena.com.b',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:9.0,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2456',portalSenha:'',portalAtivo:false,datasulCode:'2456',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F6601',sigla:'T',razaoSocial:'TIETE1',nomeFantasia:'TIETE1',cnpj:'',ie:'',email:'waldeci.mariano@tiete.com.br; edson.camilo@tiete.c',emailNF:'waldeci.mariano@tiete.com.br; edson.camilo@tiete.c',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:6.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_6601',portalSenha:'',portalAtivo:false,datasulCode:'6601',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30230',sigla:'PL',razaoSocial:'PEDRO LUIZ P',nomeFantasia:'PEDRO LUIZ P',cnpj:'',ie:'',email:'pedro@plcprojetos.com.br',emailNF:'pedro@plcprojetos.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.8,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30230',portalSenha:'',portalAtivo:false,datasulCode:'30230',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F2491',sigla:'D',razaoSocial:'DOUGLAS',nomeFantasia:'DOUGLAS',cnpj:'',ie:'',email:'vendasatacado@pneusdouglas.com.br; lucas109_hotmai',emailNF:'vendasatacado@pneusdouglas.com.br; lucas109_hotmai',telefone:'',celular:'',contato:'',cargo:'',categoria:'Servicos',score:7.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_2491',portalSenha:'',portalAtivo:false,datasulCode:'2491',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F633',sigla:'A',razaoSocial:'AQUANALYZE',nomeFantasia:'AQUANALYZE',cnpj:'',ie:'',email:'comercial@aquanalyze.com.br;contas@aquanalyze.com.',emailNF:'comercial@aquanalyze.com.br;contas@aquanalyze.com.',telefone:'',celular:'',contato:'',cargo:'',categoria:'Logistica',score:9.1,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_633',portalSenha:'',portalAtivo:false,datasulCode:'633',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F5836',sigla:'R',razaoSocial:'RUBBERPLASTI',nomeFantasia:'RUBBERPLASTI',cnpj:'',ie:'',email:'vendas9@rubberplastic.com.br',emailNF:'vendas9@rubberplastic.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Equipamentos',score:8.3,status:'Homologando',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_5836',portalSenha:'',portalAtivo:false,datasulCode:'5836',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F30755',sigla:'DP',razaoSocial:'DASP PACK EQ',nomeFantasia:'DASP PACK EQ',cnpj:'',ie:'',email:'jfrancolin@dasppack.com.br; daniel@dasppack.com.br',emailNF:'jfrancolin@dasppack.com.br; daniel@dasppack.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'Material de Escritorio',score:7.6,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_30755',portalSenha:'',portalAtivo:false,datasulCode:'30755',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F6024',sigla:'S',razaoSocial:'SERVBELT',nomeFantasia:'SERVBELT',cnpj:'',ie:'',email:'marcos@servbelt.com.br',emailNF:'marcos@servbelt.com.br',telefone:'',celular:'',contato:'',cargo:'',categoria:'MRO',score:9.2,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_6024',portalSenha:'',portalAtivo:false,datasulCode:'6024',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}},
    {id:'F407',sigla:'A',razaoSocial:'ACOLIGA',nomeFantasia:'ACOLIGA',cnpj:'',ie:'',email:'regina@acoliga.com',emailNF:'regina@acoliga.com',telefone:'',celular:'',contato:'',cargo:'',categoria:'TI & Tecnologia',score:8.5,status:'Aprovado',contratos:'--',ultimo:'--',banco:'',agencia:'',conta:'',pix:'',portalToken:'tkn_407',portalSenha:'',portalAtivo:false,datasulCode:'407',criadoEm:'01/01/2023',homologadoEm:'',docs:{contratSocial:false,certidaoNegativa:false,alvara:false,regularidadeFiscal:false}}
  ];

  var razzoPeds = [
    {id:'PC-298348',titulo:'ANALISADOR DE ENERGIA BLUE BOX D500A 120775 ISSO',fornecedor:'ISSO',valor:1200,status:'Aprovacao',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'27/03/2026',datasulPOId:'298348',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ANALISADOR DE ENERGIA BLUE BOX D500A 120775 ISSO',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298345',titulo:'SERVICOS INFORMATICA S ISS RATEIO',fornecedor:'TOTVS FILIAL',valor:1500,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'09/03/2026',previsaoEntrega:'21/03/2026',datasulPOId:'298345',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS INFORMATICA S ISS RATEIO',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298341',titulo:'ENVOLTORIO SABONETE  LIVY CAMOMILA',fornecedor:'PAPAMALIA1',valor:1800,status:'Recebido',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'10/04/2026',datasulPOId:'298341',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ENVOLTORIO SABONETE  LIVY CAMOMILA',qtd:1000,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298340',titulo:'SORBITOL LIQUIDO 70',fornecedor:'QANASTACIO4',valor:2100,status:'Recebido',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'09/03/2026',datasulPOId:'298340',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SORBITOL LIQUIDO 70',qtd:2200,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298337',titulo:'BOMBONA PLASTICA',fornecedor:'GOLPACK',valor:3600,status:'Recebido',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'05/05/2026',datasulPOId:'298337',rfqOrigem:'--',nfUpload:null,itens:[{desc:'BOMBONA PLASTICA',qtd:125,unid:'UN',valor:1200},{desc:'BOMBONA PLASTICA',qtd:125,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298336',titulo:'AUXILIAR FILTRANTE',fornecedor:'IMERYS 2',valor:2700,status:'Recebido',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'06/05/2026',datasulPOId:'298336',rfqOrigem:'--',nfUpload:null,itens:[{desc:'AUXILIAR FILTRANTE',qtd:2000,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298335',titulo:'TABULEIRO 1 150 X 0,984 GCAS 9545189',fornecedor:'MAET',valor:3000,status:'Recebido',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'04/05/2026',datasulPOId:'298335',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TABULEIRO 1 150 X 0,984 GCAS 9545189',qtd:3200,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298334',titulo:'RIBBON PARA ETIQUETADORA 104MM X 153M',fornecedor:'MASTERCORP',valor:3300,status:'Aprovacao',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'24/04/2026',datasulPOId:'298334',rfqOrigem:'--',nfUpload:null,itens:[{desc:'RIBBON PARA ETIQUETADORA 104MM X 153M',qtd:504,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298333',titulo:'PERFIL CARTOLA 20X35X50X35X20 X2000 1 8 GALVANIZA',fornecedor:'PERCAPI',valor:7200,status:'Aprovacao',urgente:true,cc:'QUALIDADE',emissao:'25/02/2026',previsaoEntrega:'26/02/2026',datasulPOId:'298333',rfqOrigem:'--',nfUpload:null,itens:[{desc:'PERFIL CARTOLA 20X35X50X35X20 X2000 1 8 GALVANIZA',qtd:48,unid:'UN',valor:1200},{desc:'ACAB SUPERIOR DAS LAT 70 X 45 X 70 X 6000 X 1 8',qtd:8,unid:'UN',valor:1200},{desc:'PERFIL ESTRUTURA PISO SUP 40X60X40X60X6000X1 8',qtd:24,unid:'UN',valor:1200}],historico:[{data:'25/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298332',titulo:'FITA VEDA ROSCA TEFLON  3M  19MM X 50M',fornecedor:'GERAIS6',valor:8700,status:'Recebido',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298332',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FITA VEDA ROSCA TEFLON  3M  19MM X 50M',qtd:24,unid:'UN',valor:1200},{desc:'JOGO DE CHAVE BIELA VAZADA COM FURO PASSANTE GEDORE',qtd:1,unid:'UN',valor:1200},{desc:'FITA OLEADA DE CAMBRAIA 3M 19MM X 18M',qtd:12,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298331',titulo:'SACO PLASTICO TRANSP 40 X 60 X 0,15',fornecedor:'PREMIUMPACK',valor:5400,status:'Aprovacao',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'17/04/2026',datasulPOId:'298331',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SACO PLASTICO TRANSP 40 X 60 X 0,15',qtd:20000,unid:'UN',valor:1200},{desc:'SACO PLASTICO TRANSP 30 X 40 X 0 15',qtd:20000,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298330',titulo:'SACO PLASTICO RECICLADO 52X90 0,10 MM USO NA FABR',fornecedor:'SPACK',valor:4500,status:'Aprovacao',urgente:false,cc:'PCP',emissao:'09/03/2026',previsaoEntrega:'06/04/2026',datasulPOId:'298330',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SACO PLASTICO RECICLADO 52X90 0,10 MM USO NA FABR',qtd:20000,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298329',titulo:'TUBO TERMINAL CURTO PONTEIRA',fornecedor:'CARDAN',valor:9600,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298329',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TUBO TERMINAL CURTO PONTEIRA',qtd:1,unid:'UN',valor:1200},{desc:'LUVA CARDAN',qtd:1,unid:'UN',valor:1200},{desc:'CRUZETA DO CARDAN VW 10 160',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298323',titulo:'SERVICO DE MAO DE OBRA DE TROCA DE PECAS',fornecedor:'VALEX',valor:5100,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298323',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICO DE MAO DE OBRA DE TROCA DE PECAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298322',titulo:'CAIXA ORGANIZADORA 13 L',fornecedor:'Femapel Pape',valor:10200,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298322',rfqOrigem:'--',nfUpload:null,itens:[{desc:'CAIXA ORGANIZADORA 13 L',qtd:2,unid:'UN',valor:1200},{desc:'CAIXA ORGANIZADORA ALTA 25 L',qtd:2,unid:'UN',valor:1200},{desc:'CAIXA ORGANIZADORA 42 L',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298321',titulo:'BLOCO MOVIMENTO DE PORTARIA',fornecedor:'KRATOS',valor:8100,status:'Recebido',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'14/03/2026',datasulPOId:'298321',rfqOrigem:'--',nfUpload:null,itens:[{desc:'BLOCO MOVIMENTO DE PORTARIA',qtd:100,unid:'UN',valor:1200},{desc:'BLOCO P ANEXO DAS FICHAS DE PESAGEM',qtd:200,unid:'UN',valor:1200},{desc:'BLOCO DE ENT SAIDA DE FUNCIONARIOS',qtd:40,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298317',titulo:'SELO MECANICO 35,0MM AGUA QUENTE',fornecedor:'FLUID SYSTEM',valor:8400,status:'Recebido',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298317',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SELO MECANICO 35,0MM AGUA QUENTE',qtd:2,unid:'UN',valor:1200},{desc:'SELO MECANICO 35MM SODA',qtd:2,unid:'UN',valor:1200},{desc:'SELO MECANICO 35,0MM GORDURA',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298316',titulo:'LUVA PARA SELO MECANICO 35 X 61,7MM',fornecedor:'FLUID SYSTEM',valor:6300,status:'Recebido',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298316',rfqOrigem:'--',nfUpload:null,itens:[{desc:'LUVA PARA SELO MECANICO 35 X 61,7MM',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298315',titulo:'LUVA PARA SELO MECANICO 35 X 61,6MM',fornecedor:'FLUID SYSTEM',valor:7800,status:'Recebido',urgente:false,cc:'PCM',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298315',rfqOrigem:'--',nfUpload:null,itens:[{desc:'LUVA PARA SELO MECANICO 35 X 61,6MM',qtd:2,unid:'UN',valor:1200},{desc:'SELO MECANICO 1 3 4',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298307',titulo:'SERVICO DE APP E MONITORAMENTO DA FROTA',fornecedor:'SMARTEC INFO',valor:6900,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298307',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICO DE APP E MONITORAMENTO DA FROTA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298306',titulo:'SERVICO DE CONSERTO EM PNEUS',fornecedor:'PNEUCARGO',valor:7200,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298306',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICO DE CONSERTO EM PNEUS',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298305',titulo:'REFORMA DE PNEU 215 / 75R 17,5',fornecedor:'PNEUCARGO',valor:8700,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298305',rfqOrigem:'--',nfUpload:null,itens:[{desc:'REFORMA DE PNEU 215 / 75R 17,5',qtd:4,unid:'UN',valor:1200},{desc:'REFORMA DE PNEU 295 / 80R 22,5',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298304',titulo:'SERVICO DE CONSERTO DE TACOGRAFO',fornecedor:'DNS',valor:7800,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298304',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICO DE CONSERTO DE TACOGRAFO',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298302',titulo:'OLEO PARA MOTOR DIESEL 15W40',fornecedor:'VALEX',valor:8100,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298302',rfqOrigem:'--',nfUpload:null,itens:[{desc:'OLEO PARA MOTOR DIESEL 15W40',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298301',titulo:'FILTRO LUBRIFICANTE LF16015 FLET GUARD',fornecedor:'VALEX',valor:9600,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298301',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FILTRO LUBRIFICANTE LF16015 FLET GUARD',qtd:1,unid:'UN',valor:1200},{desc:'OLEO IPITUR AW 68 HIDRAULICO',qtd:1,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298298',titulo:'VOLANTE DE DIRECAO',fornecedor:'ANCHIETA PE',valor:8700,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'09/03/2026',previsaoEntrega:'10/03/2026',datasulPOId:'298298',rfqOrigem:'--',nfUpload:null,itens:[{desc:'VOLANTE DE DIRECAO',qtd:2,unid:'UN',valor:1200}],historico:[{data:'09/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298294',titulo:'LUVA PARA SELO MECANICO 35 X 123MM',fornecedor:'FLUID SYSTEM',valor:10200,status:'Recebido',urgente:false,cc:'PCM',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298294',rfqOrigem:'--',nfUpload:null,itens:[{desc:'LUVA PARA SELO MECANICO 35 X 123MM',qtd:1,unid:'UN',valor:1200},{desc:'SELO MECANICO 35MM LIXIVIA GLICERINA',qtd:2,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298293',titulo:'SERVICOS ADMINISTRATIVOS CONSULTORIA S ISS',fornecedor:'MARINELLO',valor:9300,status:'Aprovacao',urgente:false,cc:'P & D',emissao:'01/01/2026',previsaoEntrega:'05/01/2026',datasulPOId:'298293',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS ADMINISTRATIVOS CONSULTORIA S ISS',qtd:12,unid:'UN',valor:1200}],historico:[{data:'01/01/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298289',titulo:'SERVICOS ADMINISTRATIVOS CONSULTORIA TRIBUTA',fornecedor:'VALIDEINFOW',valor:9600,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298289',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS ADMINISTRATIVOS CONSULTORIA TRIBUTA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298288',titulo:'FILTRO DE AR PARA PEGADOR DE CAIXAS B39188 IMA',fornecedor:'I.M.A. INDUS',valor:11100,status:'Recebido',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'06/03/2026',previsaoEntrega:'08/04/2026',datasulPOId:'298288',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FILTRO DE AR PARA PEGADOR DE CAIXAS B39188 IMA',qtd:10,unid:'UN',valor:1200},{desc:'SPESE12 COSTOMS E PACKAGIN CHARGES',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298287',titulo:'SERVICOS INFORMATICA S ISS RATEIO',fornecedor:'TOTVS',valor:10200,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'18/03/2026',datasulPOId:'298287',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS INFORMATICA S ISS RATEIO',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298285',titulo:'TELEFONIA',fornecedor:'TELEFONICA1',valor:10500,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298285',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TELEFONIA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298279',titulo:'SERVICOS INFORMATICA S ISS RATEIO',fornecedor:'TOTVS',valor:10800,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'18/03/2026',datasulPOId:'298279',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS INFORMATICA S ISS RATEIO',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298277',titulo:'FRETES SOBRE COMPRAS',fornecedor:'GVSLOGR',valor:11100,status:'Recebido',urgente:false,cc:'P & D',emissao:'04/03/2026',previsaoEntrega:'04/03/2026',datasulPOId:'298277',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FRETES SOBRE COMPRAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'04/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298275',titulo:'SERVICOS INFORMATICA S ISS',fornecedor:'4DS CLOUD &',valor:11400,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298275',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS INFORMATICA S ISS',qtd:12,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298274',titulo:'FECHO PADRAO COM CHAVE 0320221 NILKO',fornecedor:'NILKO',valor:15300,status:'Recebido',urgente:false,cc:'PCM',emissao:'04/03/2026',previsaoEntrega:'10/04/2026',datasulPOId:'298274',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FECHO PADRAO COM CHAVE 0320221 NILKO',qtd:75,unid:'UN',valor:1200},{desc:'ESCUDO PARA ARMARIOS COR BEGE NILKO',qtd:75,unid:'UN',valor:1200},{desc:'CHAPA REFORCO FECHO CADEADO NILKO',qtd:75,unid:'UN',valor:1200}],historico:[{data:'04/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298272',titulo:'VIBRADOR PNEUMATICO ROTATIVO DE ROLOS UCVR 1 4',fornecedor:'M.V.L. MAQUI',valor:12000,status:'Recebido',urgente:false,cc:'PCM',emissao:'06/03/2026',previsaoEntrega:'21/03/2026',datasulPOId:'298272',rfqOrigem:'--',nfUpload:null,itens:[{desc:'VIBRADOR PNEUMATICO ROTATIVO DE ROLOS UCVR 1 4',qtd:2,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298271',titulo:'FILTRO DE CARVAO 10  PURIFICADOR GEHAKA',fornecedor:'AVANCINI EQU',valor:14700,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/12/2025',previsaoEntrega:'30/12/2025',datasulPOId:'298271',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FILTRO DE CARVAO 10  PURIFICADOR GEHAKA',qtd:1,unid:'UN',valor:1200},{desc:'MEMBRANA DE OSMOSE REVERSA  PURIFICADOR GEHAKA',qtd:1,unid:'UN',valor:1200},{desc:'FILTRO DEIONIZADOR 10  PURIFICADOR GEHAKA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'01/12/2025',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298269',titulo:'LUBRIFICADOR AUTOMATICO LAGD 125/WA2 SKF',fornecedor:'THEVAL PRODU',valor:13800,status:'Recebido',urgente:false,cc:'PCM',emissao:'06/03/2026',previsaoEntrega:'11/03/2026',datasulPOId:'298269',rfqOrigem:'--',nfUpload:null,itens:[{desc:'LUBRIFICADOR AUTOMATICO LAGD 125/WA2 SKF',qtd:3,unid:'UN',valor:1200},{desc:'GRAXA LGHB 2/18 SKF - ALTA TEMPERATURA  18KG',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298265',titulo:'CARTUCHO DE TINTA SP4',fornecedor:'PACKFAI',valor:12900,status:'Recebido',urgente:false,cc:'PCM',emissao:'06/03/2026',previsaoEntrega:'11/03/2026',datasulPOId:'298265',rfqOrigem:'--',nfUpload:null,itens:[{desc:'CARTUCHO DE TINTA SP4',qtd:3,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298263',titulo:'OLEO MEROPA 320 TEXACO 20L',fornecedor:'ORIGINAL',valor:14400,status:'Recebido',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'06/03/2026',previsaoEntrega:'19/03/2026',datasulPOId:'298263',rfqOrigem:'--',nfUpload:null,itens:[{desc:'OLEO MEROPA 320 TEXACO 20L',qtd:2,unid:'UN',valor:1200},{desc:'OLEO MEROPA 320 TEXACO 20L',qtd:8,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298255',titulo:'TIOSSULFATO DE SODIO 0,01N',fornecedor:'SINERGIA COM',valor:17100,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/01/2026',previsaoEntrega:'28/02/2026',datasulPOId:'298255',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TIOSSULFATO DE SODIO 0,01N',qtd:1,unid:'UN',valor:1200},{desc:'TIOSSULFATO DE SODIO 0,01N',qtd:1,unid:'UN',valor:1200},{desc:'TIOSSULFATO DE SODIO 0,01N',qtd:1,unid:'UN',valor:1200}],historico:[{data:'01/01/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298254',titulo:'MANGUEIRA DA TORRE',fornecedor:'GOLDWORK',valor:15000,status:'Aprovacao',urgente:false,cc:'QUALIDADE',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298254',rfqOrigem:'--',nfUpload:null,itens:[{desc:'MANGUEIRA DA TORRE',qtd:2,unid:'UN',valor:1200},{desc:'SERVICO DE MANUTENCAO CORRETIVA EM EMPILHADEIRA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298251',titulo:'SMARTPHONE SAMSUNG GALAXY A03',fornecedor:'MAGALU226',valor:14100,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'06/03/2026',previsaoEntrega:'07/03/2026',datasulPOId:'298251',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SMARTPHONE SAMSUNG GALAXY A03',qtd:1,unid:'UN',valor:1200}],historico:[{data:'06/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298250',titulo:'BEQUER 1000ML',fornecedor:'SINERGIA COM',valor:14400,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298250',rfqOrigem:'--',nfUpload:null,itens:[{desc:'BEQUER 1000ML',qtd:25,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298249',titulo:'BLEND 67 33 BRANQUEADO OLEO DE PALMA ESTEARIN',fornecedor:'A. AZEVEDO',valor:14700,status:'Aprovacao',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'16/03/2026',datasulPOId:'298249',rfqOrigem:'--',nfUpload:null,itens:[{desc:'BLEND 67 33 BRANQUEADO OLEO DE PALMA ESTEARIN',qtd:35000,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298248',titulo:'MULTAS TRABALHISTAS',fornecedor:'SECRETARI DS',valor:16200,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'05/03/2026',previsaoEntrega:'05/03/2026',datasulPOId:'298248',rfqOrigem:'--',nfUpload:null,itens:[{desc:'MULTAS TRABALHISTAS',qtd:1,unid:'UN',valor:1200},{desc:'MULTAS TRABALHISTAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298247',titulo:'JALECO AZUL  N 64 C BOLSO',fornecedor:'MARIUSA',valor:20100,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298247',rfqOrigem:'--',nfUpload:null,itens:[{desc:'JALECO AZUL  N 64 C BOLSO',qtd:4,unid:'UN',valor:1200},{desc:'CAMISA  POLO AZUL P 40 FROTA',qtd:20,unid:'UN',valor:1200},{desc:'CAMISA  POLO AZUL M 42 FROTA',qtd:20,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298244',titulo:'COMBI TITRANT 5',fornecedor:'SINERGIA COM',valor:20400,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/02/2026',previsaoEntrega:'02/02/2026',datasulPOId:'298244',rfqOrigem:'--',nfUpload:null,itens:[{desc:'COMBI TITRANT 5',qtd:3,unid:'UN',valor:1200},{desc:'COMBI TITRANT 5',qtd:3,unid:'UN',valor:1200},{desc:'COMBI TITRANT 5',qtd:3,unid:'UN',valor:1200}],historico:[{data:'01/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298243',titulo:'ALCOOL ISOPROPILICO P.A',fornecedor:'SINERGIA COM',valor:20700,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/03/2026',previsaoEntrega:'02/03/2026',datasulPOId:'298243',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ALCOOL ISOPROPILICO P.A',qtd:17,unid:'UN',valor:1200},{desc:'ALCOOL ISOPROPILICO P.A',qtd:17,unid:'UN',valor:1200},{desc:'ALCOOL ISOPROPILICO P.A',qtd:17,unid:'UN',valor:1200}],historico:[{data:'01/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298242',titulo:'TIOSSULFATO DE SODIO 0,1N',fornecedor:'SINERGIA COM',valor:21000,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'28/02/2026',previsaoEntrega:'28/02/2026',datasulPOId:'298242',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TIOSSULFATO DE SODIO 0,1N',qtd:3,unid:'UN',valor:1200},{desc:'TIOSSULFATO DE SODIO 0,1N',qtd:3,unid:'UN',valor:1200},{desc:'TIOSSULFATO DE SODIO 0,1N',qtd:3,unid:'UN',valor:1200}],historico:[{data:'28/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298241',titulo:'NITRATO DE PRATA P.A',fornecedor:'SINERGIA COM',valor:21300,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/03/2026',previsaoEntrega:'02/03/2026',datasulPOId:'298241',rfqOrigem:'--',nfUpload:null,itens:[{desc:'NITRATO DE PRATA P.A',qtd:2,unid:'UN',valor:1200},{desc:'NITRATO DE PRATA P.A',qtd:2,unid:'UN',valor:1200},{desc:'NITRATO DE PRATA P.A',qtd:2,unid:'UN',valor:1200}],historico:[{data:'01/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298240',titulo:'VALVULA ESFERA A C 1 1 2 SOLDA',fornecedor:'OCTAL VALV',valor:21600,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'08/03/2026',datasulPOId:'298240',rfqOrigem:'--',nfUpload:null,itens:[{desc:'VALVULA ESFERA A C 1 1 2 SOLDA',qtd:6,unid:'UN',valor:1200},{desc:'VALVULA ESFERA A C 2 SOLDA',qtd:10,unid:'UN',valor:1200},{desc:'CAP DN 8\'\' SCHD 40S',qtd:2,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298239',titulo:'OLEO 100 VEGETAL BLEND 45 45 10 RSPO',fornecedor:'CRA 2',valor:17100,status:'Recebido',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'05/03/2026',datasulPOId:'298239',rfqOrigem:'--',nfUpload:null,itens:[{desc:'OLEO 100 VEGETAL BLEND 45 45 10 RSPO',qtd:35000,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298238',titulo:'SERVICOS MANUTENCAO DE MAQUINAS',fornecedor:'CAMPSELOSA',valor:17400,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298238',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS MANUTENCAO DE MAQUINAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298237',titulo:'SERVICOS - MAO DE OBRA',fornecedor:'SOCADEIRAS',valor:17700,status:'Recebido',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298237',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS - MAO DE OBRA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298236',titulo:'SERVICOS MANUT DE MAQUINAS MANUTENCAO ELETRICA',fornecedor:'YES ROBOTICA',valor:18000,status:'Aprovacao',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298236',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS MANUT DE MAQUINAS MANUTENCAO ELETRICA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298235',titulo:'BRACO DOBRADOR DE ABA DO CARTUCHO RZ-DE-112-ME-00074',fornecedor:'FUSH FERRAME',valor:18300,status:'Recebido',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'05/03/2026',previsaoEntrega:'27/03/2026',datasulPOId:'298235',rfqOrigem:'--',nfUpload:null,itens:[{desc:'BRACO DOBRADOR DE ABA DO CARTUCHO RZ-DE-112-ME-00074',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298234',titulo:'HEXANO PA',fornecedor:'SINERGIA COM',valor:23400,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'02/02/2026',previsaoEntrega:'02/03/2026',datasulPOId:'298234',rfqOrigem:'--',nfUpload:null,itens:[{desc:'HEXANO PA',qtd:10,unid:'UN',valor:1200},{desc:'HEXANO PA',qtd:10,unid:'UN',valor:1200},{desc:'HEXANO PA',qtd:10,unid:'UN',valor:1200}],historico:[{data:'02/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298233',titulo:'SERVICOS MANUT DE MAQUINAS MANUTENCAO ELETRICA',fornecedor:'NEXIS SISTEM',valor:18900,status:'Aprovacao',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298233',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS MANUT DE MAQUINAS MANUTENCAO ELETRICA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298231',titulo:'SERVICOS - MAO DE OBRA',fornecedor:'STELLA',valor:19200,status:'Recebido',urgente:false,cc:'MANUTENCAO PREDIAL',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298231',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS - MAO DE OBRA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298229',titulo:'CLOROFORMIO P.A',fornecedor:'SINERGIA COM',valor:24300,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'01/02/2026',previsaoEntrega:'02/02/2026',datasulPOId:'298229',rfqOrigem:'--',nfUpload:null,itens:[{desc:'CLOROFORMIO P.A',qtd:3,unid:'UN',valor:1200},{desc:'CLOROFORMIO P.A',qtd:3,unid:'UN',valor:1200},{desc:'CLOROFORMIO P.A',qtd:3,unid:'UN',valor:1200}],historico:[{data:'01/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298227',titulo:'ALCOOL METILICO P.A',fornecedor:'SINERGIA COM',valor:24600,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'20/02/2026',previsaoEntrega:'20/02/2026',datasulPOId:'298227',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ALCOOL METILICO P.A',qtd:4,unid:'UN',valor:1200},{desc:'ALCOOL METILICO P.A',qtd:4,unid:'UN',valor:1200},{desc:'ALCOOL METILICO P.A',qtd:4,unid:'UN',valor:1200}],historico:[{data:'20/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298226',titulo:'SERVICOS - MAO DE OBRA',fornecedor:'IMAUTOMATICH',valor:20100,status:'Recebido',urgente:false,cc:'SABONETE',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298226',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS - MAO DE OBRA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298224',titulo:'CATRACA DE FREIO TRASEIRA MBB 1418 ATEGO',fornecedor:'MORELATE SUD',valor:20400,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298224',rfqOrigem:'--',nfUpload:null,itens:[{desc:'CATRACA DE FREIO TRASEIRA MBB 1418 ATEGO',qtd:2,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298223',titulo:'APARELHO CELULAR',fornecedor:'MAGALU226',valor:20700,status:'Aprovacao',urgente:false,cc:'INFORMATICA',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298223',rfqOrigem:'--',nfUpload:null,itens:[{desc:'APARELHO CELULAR',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298222',titulo:'ACIDO SULFURICO 0,5N',fornecedor:'SINERGIA COM',valor:25800,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'08/02/2026',previsaoEntrega:'02/03/2026',datasulPOId:'298222',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ACIDO SULFURICO 0,5N',qtd:2,unid:'UN',valor:1200},{desc:'ACIDO SULFURICO 0,5N',qtd:2,unid:'UN',valor:1200},{desc:'ACIDO SULFURICO 0,5N',qtd:2,unid:'UN',valor:1200}],historico:[{data:'08/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298221',titulo:'SERVICOS LOCACAO DE EQUIP P RESIDUOS ORGANICOS',fornecedor:'LUVITECHAMB',valor:22500,status:'Recebido',urgente:false,cc:'SESMT',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298221',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS LOCACAO DE EQUIP P RESIDUOS ORGANICOS',qtd:1,unid:'UN',valor:1200},{desc:'SERVICOS DESCARTE DE RESIDUOS C ISS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298219',titulo:'TINTA PARA INKJET DOMINO',fornecedor:'SUNNYVALE',valor:22800,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298219',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TINTA PARA INKJET DOMINO',qtd:24,unid:'UN',valor:1200},{desc:'SOLVENTE PARA INKJET DOMINO',qtd:24,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298218',titulo:'FRETES SOBRE COMPRAS',fornecedor:'GVSLOGR',valor:21900,status:'Recebido',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'05/03/2026',datasulPOId:'298218',rfqOrigem:'--',nfUpload:null,itens:[{desc:'FRETES SOBRE COMPRAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298217',titulo:'ACIDO CLORIDRICO 0,1N',fornecedor:'SINERGIA COM',valor:25800,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'02/02/2026',previsaoEntrega:'02/02/2026',datasulPOId:'298217',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ACIDO CLORIDRICO 0,1N',qtd:1,unid:'UN',valor:1200},{desc:'ACIDO CLORIDRICO 0,1N',qtd:1,unid:'UN',valor:1200},{desc:'ACIDO CLORIDRICO 0,1N',qtd:1,unid:'UN',valor:1200}],historico:[{data:'02/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298216',titulo:'ACIDO ACETICO GLACIAL P.A',fornecedor:'SINERGIA COM',valor:27300,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'02/03/2026',previsaoEntrega:'02/03/2026',datasulPOId:'298216',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ACIDO ACETICO GLACIAL P.A',qtd:1,unid:'UN',valor:1200},{desc:'ACIDO ACETICO GLACIAL P.A',qtd:1,unid:'UN',valor:1200},{desc:'ACIDO ACETICO GLACIAL P.A',qtd:1,unid:'UN',valor:1200}],historico:[{data:'02/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298215',titulo:'ANEL VEDACAO P/ BACIA CERA ESTEVES',fornecedor:'CASANANCY',valor:27600,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298215',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ANEL VEDACAO P/ BACIA CERA ESTEVES',qtd:2,unid:'UN',valor:1200},{desc:'PARAFUSO LUXO S-12 FIXAR BACIA (PAR)',qtd:2,unid:'UN',valor:1200},{desc:'REPARO PARA CAIXA ACOPLADA DECA',qtd:2,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298214',titulo:'ACETONA P.A',fornecedor:'SINERGIA COM',valor:26700,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'02/02/2026',previsaoEntrega:'02/02/2026',datasulPOId:'298214',rfqOrigem:'--',nfUpload:null,itens:[{desc:'ACETONA P.A',qtd:1,unid:'UN',valor:1200},{desc:'ACETONA P.A',qtd:1,unid:'UN',valor:1200},{desc:'ACETONA P.A',qtd:1,unid:'UN',valor:1200}],historico:[{data:'02/02/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298213',titulo:'SERVICOS MANUTENCAO MAQUINAS',fornecedor:'SMARTLIFTEL',valor:28200,status:'Aprovacao',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'04/04/2026',datasulPOId:'298213',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS MANUTENCAO MAQUINAS',qtd:1,unid:'UN',valor:1200},{desc:'SERVICOS MANUTENCAO MAQUINAS',qtd:1,unid:'UN',valor:1200},{desc:'SERVICOS MANUTENCAO MAQUINAS',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298212',titulo:'SODA CAUSTICA EM ESCAMAS',fornecedor:'UNIPAR',valor:23700,status:'Recebido',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'04/05/2026',datasulPOId:'298212',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SODA CAUSTICA EM ESCAMAS',qtd:1650,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298211',titulo:'PLANTAPON LGC SORB',fornecedor:'BASF S.A.',valor:24000,status:'Recebido',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'04/05/2026',datasulPOId:'298211',rfqOrigem:'--',nfUpload:null,itens:[{desc:'PLANTAPON LGC SORB',qtd:2240,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298210',titulo:'POLISSORBATO 60',fornecedor:'CRODA',valor:24300,status:'Recebido',urgente:false,cc:'PCP',emissao:'05/03/2026',previsaoEntrega:'04/05/2026',datasulPOId:'298210',rfqOrigem:'--',nfUpload:null,itens:[{desc:'POLISSORBATO 60',qtd:1700,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298209',titulo:'SERVICOS - MAO DE OBRA',fornecedor:'AGUAVITALMA',valor:24600,status:'Recebido',urgente:false,cc:'PCM',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298209',rfqOrigem:'--',nfUpload:null,itens:[{desc:'SERVICOS - MAO DE OBRA',qtd:1,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]},
    {id:'PC-298208',titulo:'TAMBOR VAZIO DE 200 LITROS COM TAMPA',fornecedor:'VICTOR YUDI',valor:24900,status:'Recebido',urgente:false,cc:'QUALIDADE',emissao:'05/03/2026',previsaoEntrega:'06/03/2026',datasulPOId:'298208',rfqOrigem:'--',nfUpload:null,itens:[{desc:'TAMBOR VAZIO DE 200 LITROS COM TAMPA',qtd:30,unid:'UN',valor:1200}],historico:[{data:'05/03/2026',acao:'Importado do Datasul',user:'Sistema',cor:'blue'}]}
  ];

  var razzoReqs = [
    {id:'REQ-51813',descricao:'SERVICOS CONTRATADOS',solicitante:'vvidotto - INFORMATICA',valor:800,prioridade:'Alta',status:'Aprovada',cc:'INFORMATICA',categoria:'MRO',data:'17/04/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-53002',descricao:'GAS GLP ENVASADO',solicitante:'nalves - FREGUESIA CAMPINAS',valor:800,prioridade:'Media',status:'Em analise',cc:'FREGUESIA CAMPINAS',categoria:'MRO',data:'07/05/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-61781',descricao:'GAIOLA PARA ARMAZENAMENTO P/ ARAMADA DIVISORIA',solicitante:'lteixeira - SABONETE',valor:2400,prioridade:'Baixa',status:'Aprovada',cc:'SABONETE',categoria:'MRO',data:'05/09/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-62170',descricao:'ADESIVO DE PERIGO',solicitante:'nsantana - QUALIDADE',valor:800,prioridade:'Alta',status:'Aprovada',cc:'QUALIDADE',categoria:'MRO',data:'11/09/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-63500',descricao:'SLIDING BLOCK REXROTH KWD 025 SNS C1 N 1 5122348 IMA',solicitante:'nsalles - PCM',valor:800,prioridade:'Media',status:'Em analise',cc:'PCM',categoria:'MRO',data:'01/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-63500',descricao:'MOBILE CLAMP DOWEL COD B582296 IMA',solicitante:'nsalles - PCM',valor:1600,prioridade:'Baixa',status:'Em analise',cc:'PCM',categoria:'MRO',data:'01/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-63500',descricao:'INNER TUBE VEROL CL15CAGS COD 5934289 IMA',solicitante:'nsalles - PCM',valor:1200000,prioridade:'Alta',status:'Em analise',cc:'PCM',categoria:'MRO',data:'01/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-63897',descricao:'SERVICOS DESCARTE DE RESIDUOS C ISS IR PCC',solicitante:'mcesario - SESMT',valor:800,prioridade:'Media',status:'Aprovada',cc:'SESMT',categoria:'MRO',data:'08/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-64721',descricao:'RODO EM PLASTICO',solicitante:'jhalmeida - QUALIDADE',valor:800,prioridade:'Baixa',status:'Aprovada',cc:'QUALIDADE',categoria:'MRO',data:'20/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-64772',descricao:'ÓCULOS SEG GRAD MULTIFOCAL ICARO CA 20406',solicitante:'asilva - SESMT',valor:800,prioridade:'Alta',status:'Aprovada',cc:'SESMT',categoria:'MRO',data:'21/10/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-65675',descricao:'RETENTOR 45X65X10MM NBR',solicitante:'nsalles - PCM',valor:6400,prioridade:'Media',status:'Aprovada',cc:'PCM',categoria:'MRO',data:'03/11/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-65942',descricao:'SERVICOS - ADMINISTRATIVO INFORMATICA -S/ISS',solicitante:'vvidotto - INFORMATICA',valor:800,prioridade:'Baixa',status:'Em analise',cc:'INFORMATICA',categoria:'MRO',data:'06/11/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-66419',descricao:'PASTA DE SILICONE VERONESI',solicitante:'nsalles - PCM',valor:800,prioridade:'Alta',status:'Em analise',cc:'PCM',categoria:'MRO',data:'13/11/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-66725',descricao:'REFLETOR LED 100W 6000K 7500LM IP65',solicitante:'nsalles - PCM',valor:16000,prioridade:'Media',status:'Aprovada',cc:'PCM',categoria:'MRO',data:'18/11/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'},
    {id:'REQ-66952',descricao:'PERFIL CARTOLA 20X35X50X35X20 X2000 1 8 GALVANIZA',solicitante:'nsantana - QUALIDADE',valor:38400,prioridade:'Baixa',status:'Em analise',cc:'QUALIDADE',categoria:'MRO',data:'21/11/2025',dataNecessaria:'31/03/2026',justificativa:'Solicitacao importada do Datasul.'}
  ];

  var razzoUsers = [
    {id:'U001',nome:'Carlos Dantas',email:'cdantas@razzo.com.br',perfil:'Admin',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'CD',ultimoAcesso:'Ha 1 dia'},
    {id:'U002',nome:'Lina Sousa',email:'linsousa@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'LS',ultimoAcesso:'Ha 2 dias'},
    {id:'U003',nome:'Felipe Juca',email:'fjuca@razzo.com.br',perfil:'Comprador',cc:'PCM',status:'Ativo',criadoEm:'01/04/2023',avatar:'FJ',ultimoAcesso:'Ha 3 dias'},
    {id:'U004',nome:'Eduardo Rossi',email:'erossi@razzo.com.br',perfil:'Aprovador',cc:'Administrativo',status:'Ativo',criadoEm:'01/04/2023',avatar:'ER',ultimoAcesso:'Ha 4 dias'},
    {id:'U005',nome:'Rafael Macena',email:'rmacena@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'RM',ultimoAcesso:'Ha 5 dias'},
    {id:'U006',nome:'Joao Cavalcante',email:'jvcavalcante@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'JC',ultimoAcesso:'Ha 6 dias'},
    {id:'U007',nome:'Jose Cardinale',email:'jcardinale@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'JC',ultimoAcesso:'Ha 7 dias'},
    {id:'U008',nome:'Fernando Santos',email:'fsantos@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'FS',ultimoAcesso:'Ha 8 dias'},
    {id:'U009',nome:'Eduardo Viana',email:'eviana@razzo.com.br',perfil:'Solicitante',cc:'Producao',status:'Ativo',criadoEm:'01/04/2023',avatar:'EV',ultimoAcesso:'Ha 9 dias'},
    {id:'U010',nome:'Lara Dias',email:'ladias@razzo.com.br',perfil:'Solicitante',cc:'Logistica',status:'Ativo',criadoEm:'01/04/2023',avatar:'LD',ultimoAcesso:'Ha 10 dias'},
    {id:'U011',nome:'Nelson Bessa',email:'nbessa@razzo.com.br',perfil:'Aprovador',cc:'Administrativo',status:'Ativo',criadoEm:'01/04/2023',avatar:'NB',ultimoAcesso:'Ha 11 dias'},
    {id:'U012',nome:'Diego Medeiros',email:'dmedeiros@razzo.com.br',perfil:'Comprador',cc:'Compras',status:'Ativo',criadoEm:'01/04/2023',avatar:'DM',ultimoAcesso:'Ha 12 dias'}
  ];

  // Injetar no MOCK (substituicao direta -- afeta todos os modulos)
  if (typeof MOCK !== 'undefined') {
    MOCK.fornecedores = razzoForns;
    MOCK.pedidos      = razzoPeds;
    MOCK.requisicoes  = razzoReqs.concat(MOCK.requisicoes.slice(0,5));
    MOCK.usuarios     = razzoUsers;
  }

  // Injetar no BF.db (modulos isolados)
  if (typeof BF !== 'undefined') {
    BF.db.fornecedores = razzoForns;
    BF.db.pedidos      = razzoPeds;
    BF.db.requisicoes  = razzoReqs;
    BF.db.usuarios     = razzoUsers;
  }

  console.log('[BidFlow] Base Razzo carregada:', {
    fornecedores: razzoForns.length,
    pedidos:      razzoPeds.length,
    requisicoes:  razzoReqs.length,
    usuarios:     razzoUsers.length,
  });
})();
...
function showPage(id) {
  ...
  if (id === 'analytics') {
    if (!_moduleInitted.analytics) {
      _moduleInitted.analytics = true;
      window.AnalyticsModule.init(document.getElementById('analytics-module-container'));
    }
  }
  if (id === 'approvals') {
    if (!_moduleInitted.approvals) {
      _moduleInitted.approvals = true;
      window.ApprovalsModule.init(document.getElementById('approvals-module-container'));
    } else { window.ApprovalsModule.filter(); }
  }
  if (id === 'suppliers') {
    if (!_moduleInitted.suppliers) {
      _moduleInitted.suppliers = true;
      window.SuppliersModule.init(document.getElementById('suppliers-module-container'));
    } else { window.SuppliersModule.filter(); }
  }
}
